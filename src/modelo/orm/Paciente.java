...
public class Paciente implements Serializable {
	...
	@Id	
	@GeneratedValue(generator="MODELO_ORM_PACIENTE_ID_GENERATOR")	
	@org.hibernate.annotations.GenericGenerator(name="MODELO_ORM_PACIENTE_ID_GENERATOR", strategy="increment")	
	private int id;
