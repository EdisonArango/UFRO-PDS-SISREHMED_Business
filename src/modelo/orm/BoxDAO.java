...
public class BoxDAO {
	...
	public static Box loadBoxByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Box) session.load(modelo.orm.Box.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Box getBoxByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Box) session.get(modelo.orm.Box.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Box loadBoxByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Box) session.load(modelo.orm.Box.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Box getBoxByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Box) session.get(modelo.orm.Box.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryBox(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From modelo.orm.Box as Box");
		if (condition != null)
	...
	public static Box createBox() {
		return new modelo.orm.Box();
	}
	
	public static boolean save(modelo.orm.Box box) throws PersistentException {
		try {
			modelo.orm.ORMSISREHMEDPersistentManager.instance().saveObject(box);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(modelo.orm.Box box) throws PersistentException {
		try {
			modelo.orm.ORMSISREHMEDPersistentManager.instance().deleteObject(box);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(modelo.orm.Box box) throws PersistentException {
		try {
			modelo.orm.ORMSISREHMEDPersistentManager.instance().getSession().refresh(box);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(modelo.orm.Box box) throws PersistentException {
		try {
			modelo.orm.ORMSISREHMEDPersistentManager.instance().getSession().evict(box);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
