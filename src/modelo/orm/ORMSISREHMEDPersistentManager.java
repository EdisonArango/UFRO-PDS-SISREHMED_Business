...
public class ORMSISREHMEDPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "ORMSISREHMED";
	...
	private ORMSISREHMEDPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ORMSISREHMEDPersistentManager();
		}
